...
beschränken.  Eine  \blue{Zufalls-Variable} $X$ ist eine Abbildung 
\\[0.2cm]
\hspace*{1.3cm}
...
Verteilungs-Funktion $F_X$ einer Zufalls-Variable $X$  mit $X \sim \mathrm{Log(1,0}$, die zugehörige
