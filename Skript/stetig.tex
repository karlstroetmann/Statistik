...
\\[0.2cm]
Definieren  wir die Zufalls-Variable $Y$ durch $Y := \varphi \circ X$ so folgt nach Satz \ref{satz:vartrans}
für die Wahrschein\-lichkeits-Dichte $p_Y$:
\\[0.2cm]
\hspace*{1.3cm}
...
\\[0.2cm]
schreiben.  Die Zufalls-Variable $Z$ ist dann als 
\\[0.2cm]
\hspace*{1.3cm}
$\ds Z(\omega) = \sum\limits_{i=1}^n X_i^2(\omega)$
\\[0.2cm]
definiert und hat eine \href{https://de.wikipedia.org/wiki/Chi-Quadrat-Verteilung}{$\chi^2$-Verteilung mit dem
...
Abbildung \ref{fig:chiSquare} auf Seite \pageref{fig:chiSquare} zeigt die Wahrscheinlichkeits-Dichten der
$\chi^2$-Verteilungen für die Freiheitsgrade $3$, $4$, $5$, $10$ und $30$.  Wir sehen, dass sich diese
...
\begin{figure}[t]
  \centering
   \epsfig{file=Abbildungen/chiSquare.pdf,scale=1.0}
   \caption{Die $\chi^2$-Verteilung mit einem Freiheitsgrad.}
  \label{fig:chiSquare}
\end{figure}
