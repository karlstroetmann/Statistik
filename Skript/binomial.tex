...
Weg die selbe ist, reicht es aus, wenn wir die Anzahl der Wege der Länge $n$ bestimmten, die von
...
\begin{Satz}
  ...
  $Y: \Omega \rightarrow \mathbb{R}$
  \\[0.3cm]
  zwei Zufallsgrößen, sind weiter $a, b \in \mathbb{R}$, so läßt sich die
...
\noindent
\textbf{Beweis}:  Dieser Beweis läßt sich durch einfaches Nachrechnen führen:
\\[0.3cm]
\hspace*{0.3cm}
$
\begin{array}[t]{cl}
