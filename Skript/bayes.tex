...
& = & \ds                           
 r^2 \cdot P\bigl(\,(X(\omega) - \mu)^2 \geq r^2 \cdot \sigma^2\bigr) \\[0.2cm]
& = & \ds
r^2 \cdot \sum\limits_{\left\{ \omega \in \Omega \,\big|\, \left(\frac{X(\omega) - \mu}{\sigma}\right)^2 \geq r^2 \right\}} P\bigl(\{\omega\}\bigr) \\[0.7cm]
& = & \ds
...
\frac{1}{\sigma^2} \cdot\sum\limits_{\omega \in \Omega} P\bigl(\{\omega\}\bigr) \cdot (X(\omega) - \mu)^2 
      \\[0.7cm]
& = & \ds
     \frac{1}{\sigma^2} \cdot \var[X(\omega)] \\[0.4cm]
& = & \ds
     1
 \end{array}
$
